...
interface EditSemesterModalProps {
	visible: boolean;
	record: dataDeclaration_schoolYear | null;
	onOk: (data: dataDeclaration_schoolYear) => void;
	onCancel: () => void;
}
...
export const EditModal: React.FC<EditSemesterModalProps> = ({
	visible,
	record,
	onOk,
	onCancel,
	...
	useEffect(() => {
		if (record) {
			setAcademicYearFrom(record.academicYearFrom);
			setAcademicYearTo(record.academicYearTo);
			setSemesters(
	...
	const handleSubmit = () => {
		...
		if (record?.id) {
			const dataUpdate: dataDeclaration_schoolYear = {
				id: record.id,
				academicYearFrom,
				academicYearTo,
				semesters,
				...
				<div className='flex items-start justify-between'>
					<div className='space-y-4'>
						...
						<div className='flex items-center gap-2'>
							<Select
								value={academicYearFrom || undefined}
								style={{ width: 120 }}
							...
							<Select
								value={academicYearTo || undefined}
								style={{ width: 120 }}
