...
interface EditClassModalProps {
	visible: boolean;
	onOk: (data: dataDeclaration_class) => void;
	onCancel: () => void;
	initialData: dataDeclaration_class | null;
}
...
export const EditClassModal: React.FC<EditClassModalProps> = ({
	...
	// Load initial data khi modal mở hoặc dữ liệu thay đổi
	useEffect(() => {
		if (visible && initialData) {
			form.setFieldsValue({
				...
				classQuantity: initialData.classQuantity,
				classType: initialData.classType,
				teacher: initialData.teacher,
				description: initialData.description,
				subjects: initialData.subjects || [],
			});
			setSubjectList(initialData.subjects || []);
		}
	...
	const handleSubmit = (values: any) => {
		if (initialData?.id) {
			const classData: dataDeclaration_class = {
				id: initialData?.id,
