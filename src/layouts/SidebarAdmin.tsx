...
const SidebarAdmin: FC = () => {
	...
	return (
		<div
			ref={divWidth}
			className={`bg-primary relative top-0 bottom-0 left-0 min-h-screen w-[112px] shadow`}
		...
		>
			...
			{isHovered && (
				<div className='absolute top-0 -right-[100%] z-50 flex min-h-screen bg-white shadow'>
					<div>
						<div>hehehe</div>
						<TabItem
							activeMainTab={activeMainTab}
